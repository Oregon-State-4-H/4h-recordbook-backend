...
type Db interface {
	...
	UpsertSection1(ctx context.Context, section Section1) (Section1, error)
	UpsertSection2(ctx context.Context, section Section2) (Section2, error)
	UpsertSection3(ctx context.Context, section Section3) (Section3, error)
	UpsertSection4(ctx context.Context, section Section4) (Section4, error)
	UpsertSection5(ctx context.Context, section Section5) (Section5, error)
	UpsertSection6(ctx context.Context, section Section6) (Section6, error)
	UpsertSection7(ctx context.Context, section Section7) (Section7, error)
	UpsertSection8(ctx context.Context, section Section8) (Section8, error)
	UpsertSection9(ctx context.Context, section Section9) (Section9, error)
	UpsertSection10(ctx context.Context, section Section10) (Section10, error)
	UpsertSection11(ctx context.Context, section Section11) (Section11, error)
	UpsertSection12(ctx context.Context, section Section12) (Section12, error)
	UpsertSection13(ctx context.Context, section Section13) (Section13, error)
	UpsertSection14(ctx context.Context, section Section14) (Section14, error)
